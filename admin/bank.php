          ...
          <div class="box-header">
            ...
            <div class="btn-group pull-right">            
              ...
              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#exampleModal">
                <i class="fa fa-plus"></i> &nbsp Tambah Saldo
              </button>
            </div>
          </div>
          <div class="box-body">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label>NOPEN KANTOR</label>
                        <input type="text" name="nama" required="required" class="form-control" placeholder="NOPEN KANTOR ..">
                      </div>

                      <div class="form-group">
                        <label>USER</label>
                        <input type="text" name="pemilik" class="form-control" placeholder="Nama pemiliki SALDO KANTOR ..">
                      </div>

                      <div class="form-group">
                        <label>NIPPOS</label>
                        <input type="text" name="nomor" class="form-control" placeholder="Nomor SALDO KANTOR ..">
                      </div>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="margin-bottom:15px;width: 100%">
                                    <label>NOPEN KANTOR</label>
                                    <input type="hidden" name="id" required="required" class="form-control" placeholder="NOPEN KANTOR .." value="<?php echo $d['bank_id']; ?>">
                                    <input type="text" name="nama" style="width:100%" required="required" class="form-control" placeholder="NOPEN KANTOR .." value="<?php echo $d['bank_nama']; ?>">
                                  </div>

                                  <div class="form-group" style="margin-bottom:15px;width: 100%">
                                    <label>USER</label>
                                    <input type="text" name="pemilik" style="width:100%" class="form-control" placeholder="User .." value="<?php echo $d['bank_pemilik']; ?>">
                                  </div>

                                  <div class="form-group" style="margin-bottom:15px;width: 100%">
                                    <label>NIPPOS</label>
                                    <input type="text" name="nomor" style="width:100%" class="form-control" placeholder="Nippos .." value="<?php echo $d['bank_nomor']; ?>">
                                  </div>

                                  <div class="form-group" style="margin-bottom:15px;width: 100%">
                                    <label>Saldo </label>
                                    <input type="number" name="saldo" style="width:100%" required="required" class="form-control" placeholder="Saldo Kantor.." value="<?php echo $d['bank_saldo']; ?>">
                                  </div>
