  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>POS IND</span>
      </a>
      ...
      <section class="sidebar">
        <div class="user-panel">
          <div class="pull-left image">
            ...
            <?php }else{ ?>
              <img src="../gambar/user/<?php echo $profil['user_foto'] ?>" class="img-circle" style="max-height:55px">
            <?php } ?>
          </div>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li>
            <a href="bank.php">
              <i class="fa fa-building"></i> <span>SALDO KANTOR</span>
            </a>
          </li>
